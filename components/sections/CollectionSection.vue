<template>
  <section class="py-8 px-3 bg-white overflow-hidden">
      ...
      <div class="relative">
        ...
        >
          <div
            ...
            } whitespace-nowrap md:text-base text-sm text-center px-6 border hover:border-secondary hover:bg-secondary transition hover:text-white cursor-pointer rounded-full `"
          ...
          <div
            ...
            :class="`py-2 ${
              currentCategory === category.id
                ? 'bg-primary border-primary text-white pointer-events-none'
                : 'border-[#5A5A5A] text-[#5A5A5A]'
            } whitespace-nowrap text-center md:text-base text-sm px-6 border hover:border-secondary hover:bg-secondary transition hover:text-white cursor-pointer rounded-full `"
        ...
        <span
          class="md:hidden block h-full w-14 pointer-events-none bg-gradient-to-r from-transparent to-white absolute top-0 right-0"
        />
        <span
          class="md:hidden block h-full w-14 pointer-events-none bg-gradient-to-r from-white to-transparent absolute top-0 left-0"
        />
      </div>
      <div class="flex gap-3 mt-12 relative md:flex-row flex-col">
        <div
          class="lg:w-1/4 md:w-1/2 w-full bg-primary rounded-xl overflow-hidden"
        >
          ...
          <div class="p-8 text-white text-center">
            ...
            <h2 class="title-font text-lg font-medium">New Arrival</h2>
            <p class="mb-8 px-4">
              Explore our latest products across all categories
            </p>
            <NuxtLink
              :href="shopLink"
        ...
        <div
          ...
          :class="{
            'opacity-20 pointer-events-none': collectionLoading.loading
          }"
        >
          <i
            id="prev-product"
          ...
          <Swiper
            ...
            class="productslider"
          >
            <template v-for="(product, index) in currentProducts" :key="index">
              <SwiperSlide>
                <ProductArchive
