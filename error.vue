<template>
  <DefaultLayout>
    <div class="max-w-lg h-auto m-auto p-8">
      <svg
      ...
      >
        ...
        />
        <path
          d="M190.147 740.228s-23.704 46.53-7.901 48.286 21.948 1.756 28.971-5.267c3.84-3.84 11.615-8.992 17.876-12.873a23.117 23.117 0 0 0 10.969-21.982c-.463-4.295-2.068-7.834-6.019-8.164-10.535-.877-22.826-10.535-22.826-10.535Zm130.811 34.239s-23.704 46.53-7.902 48.286 21.948 1.756 28.972-5.267c3.84-3.84 11.615-8.992 17.875-12.873a23.117 23.117 0 0 0 10.97-21.982c-.464-4.295-2.069-7.834-6.02-8.164-10.534-.877-22.825-10.535-22.825-10.535Z"
          fill="#2f2e41"
        />
        <circle
          cx="295.905"
      ...
      <p class="text-9xl text-center mt-6">
        {{ error.statusCode }}
      </p>
